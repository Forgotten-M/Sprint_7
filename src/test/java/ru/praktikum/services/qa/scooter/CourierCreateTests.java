...
public class CourierCreateTests extends BaseTest{
    ...
    @Test
    @DisplayName("Проверка статус-кода ответа успешного создания курьера")
    ...
    @Test
    @DisplayName("Проверка статус-кода ответа повторного использования логина")
    ...
    @Test
    @DisplayName("Проверка тела ответа повторного использования логина")
    ...
    @Test
    @DisplayName("Проверка статус-кода ответа о недостающем обязательном поле")
    ...
    @Test
    @DisplayName("Проверка тела ответа о недостающем обязательном поле")
